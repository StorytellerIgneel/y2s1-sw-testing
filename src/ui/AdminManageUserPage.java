...
public class AdminManageUserPage {
    ...
    public void manageUserPage(int userIdx, ArrayList<SystemAdminAccount> admins,
            ArrayList<UserAccount> users, Scanner scanner) {
    ...
    public void viewListOfUsers(Scanner scanner) {
        ...
        for (int i = 0; i < userAccounts.size(); i++) {
            System.out.printf("%10s\t%-30s\n", userAccounts.get(i).getAccountId(),
                    userAccounts.get(i).getName());
        }
